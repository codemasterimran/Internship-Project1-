        ...
        <div class="version-notification">
            <div class="notification-content">
                ...
                <div>
                    ...
                    <p class="small-text">You're currently using v<?= htmlspecialchars($_SESSION['installed_version'] ?? $currentWebAppVersion) ?></p>
                </div>
...
<div class="screen welcome-screen active">
    ...
    <h1>Database Setup Wizard v<?= htmlspecialchars($_SESSION['installed_version'] ?? $currentWebAppVersion) ?></h1>
    ...
    <div class="button-group">
        ...
        <div class="screen database-screen active">
            ...
            <form method="post" action="?screen=sql_editor" class="upload-form">
            <div class="form-group">
