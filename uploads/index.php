    ...
    <div class="app-container">
        ...
        <div class="screen database-screen active">
            ...
            <form method="post" enctype="multipart/form-data" class="upload-form">
                <div class="form-group">
                    ...
                    <input type="text" id="db_host" name="db_host" value="<?= htmlspecialchars($_SESSION['db_host'] ?? 'localhost') ?>" required>
                </div>
                
                <div class="form-group">
                    <label for="db_username">Username</label>
                    <input type="text" id="db_username" name="db_username" value="<?= htmlspecialchars($_SESSION['db_username'] ?? 'root') ?>" required>
                </div>
                
                <div class="form-group">
                    <label for="db_password">Password</label>
                    <input type="password" id="db_password" name="db_password" value="<?= htmlspecialchars($_SESSION['db_password'] ?? '') ?>">
                </div>
                
                <div class="form-group">
                    <label for="db_name">Database Name</label>
                    <input type="text" id="db_name" name="db_name" value="<?= htmlspecialchars($_SESSION['db_name'] ?? '') ?>" placeholder="Enter any database name" required>
        ...
        <div class="screen sql-editor-screen active">
            ...
            <form method="post" class="sql-editor-form">
                ...
                <input type="hidden" name="db_username" value="<?= htmlspecialchars($_SESSION['db_username'] ?? 'root') ?>">
                <input type="hidden" name="db_password" value="<?= htmlspecialchars($_SESSION['db_password'] ?? '') ?>">
